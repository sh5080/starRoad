...
/** 관광지 모두 조회하기 */
export const getAllTouristDestination:typeof docs.getAllTouristDestination = async (req: CustomRequest, res: Response, next: NextFunction) => {
  try {
...
/** 관광지 상세 조회하기 */
export const getTouristDestination:typeof docs.getTouristDestination = async (req: CustomRequest, res: Response, next: NextFunction) => {
  try {
